...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td colspan="3" style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
            <b>Pending staff and student approvals.</b>
          </td>
        </tr>
        <tr>
          <td>
            ...
            <#list approvalModels as center>
              <tr>
                <td>${center.centerName}</td>
                <td>${center.studentApprovalCount}</td>
                <td>${center.staffApprovalCount}</td>
              </tr>
            </#list>
            </table>
          </td>
  ...
  <tr>
    <td>
      <p>
        For Student approval <a href="${baseURL}/mis/index.html#!/app/student_approvals">click here</a><br/>
        For Staff approval <a href="${baseURL}/mis/index.html#!/app/staff_approvals">click here</a>
      </p>
    </td>
  </tr>
  <tr>

      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
            <b>Student ${student.profile.fullName} ${student.center.name}, ${student.program.name}, ${student.group.name}. Profile detail has been rejected because of the below reason.
             Please make the necessary changes and submit again for approval</b>
            <br>
            <b>Rejection Reason: ${student.rejectionReason}</b>
          </td>
        </tr>
        <tr>

      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
            <b>New Query/Feedback message from ${query.parent.fullName} <br>
              Parent of ${query.parent.student.name} , ${query.parent.student.center.name} - ${query.parent.student.program.name} </b>
          </td>
        </tr>
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
            <br>
            Please click
            <a href="${baseURL}mis/index.html#!/app/support/view/${maskedId?c}">here</a>
            to view the request!
          </td>
        </tr>
        <tr>
